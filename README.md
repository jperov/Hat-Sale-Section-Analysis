...
The below displays the SQL queries used on an anonymized version of a real report that I presented to management which led to 20 stores changing their sale section pricing structure, and resulted in the segments monthly revenue increasing by 25%. 
